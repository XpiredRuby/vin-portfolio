...
checks = {
    ...
    "Rocket Landing promoted once": projects.count('data-project-key="rocket"') == 1,
    "AeroFrame claims are current": "+0.078" in index and "+0.078" in projects and "16/18" in index and "16/18" in projects,
